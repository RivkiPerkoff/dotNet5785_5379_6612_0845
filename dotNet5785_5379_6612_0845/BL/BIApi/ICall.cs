...
public interface ICall
{
    ...
    IEnumerable<BO.ClosedCallInList> GetClosedCallsForVolunteer(int volunteerId, CallTypes? filterType, ClosedCallInListFields? sortField);
    ...
    IEnumerable<BO.OpenCallInList> GetOpenCallsForVolunteerSelection(int volunteerId, CallTypes? filterField, OpenCallInListFields? sortField);
